...
urlpatterns = [
    ...
    path('contracts/', ContractsIncomingView.as_view(), name='contracts'),
    ...
    path('contracts_contractor/', ContractsContractorView.as_view(), name='contracts_contractor'),
    path('contracts_contractor/view/<int:contract_id>/', contract_contractor_view, name='contract_contractor_view'),
]
