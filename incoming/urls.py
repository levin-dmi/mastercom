...
urlpatterns = [
    ...
    path('inc/projects/view/<int:project_id>/', project_view, name='project_view'),
    ...
    path('inc/payments/', payments, name='payments'),
    ...
    path('inc/payments/view/<int:payment_id>/', payment_view, name='payment_view'),
