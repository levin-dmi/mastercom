...
urlpatterns = [
    path('', AnalyticView.as_view(), name='index'),
    ...
    path('inc/acts/view/<int:pk>/', ActDetailView.as_view(), name='act_view'),
    ...
    path('ctr/analytic_contractor/', AnalyticContractorView.as_view(), name='analytic_contractor'),
    ...
    path('ctr/contracts/add/<int:partner_id>/', ContractContractorCreateView.as_view(), name='contract_contracor_add_to_part'),  # к контрагенту
    ...
    path('ctr/acts/', ActContractorView.as_view(), name='acts_contractor'),
    path('ctr/acts/view/<int:pk>/', ActContractorDetailView.as_view(), name='act_contractor_view'),
    path('ctr/acts/add/', ActContractorCreateView.as_view(), name='act_contractor_add'),
    path('ctr/acts/add/<int:contract_id>/', ActContractorCreateView.as_view(), name='act_contractor_add_to_ctr'),  # в договор
    path('ctr/acts/update/<int:pk>/', ActContractorUpdateView.as_view(), name='act_contractor_update'),
    path('ctr/acts/delete/<int:pk>/', ActContractorDeleteView.as_view(), name='act_contractor_delete'),
